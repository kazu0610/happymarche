<nav x-data="{ open: false }" class="bg-orange-400 border-b border-gray-200">
            ...
            <div class="flex ">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                      <img src="{{asset('logo/happymarche1.png')}}" style="max-height:50px;">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('users.favorite')" :active="request()->routeIs('users.favorite')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('carts.index')">
                {{ __('カートを見る') }}
            </x-responsive-nav-link>
        </div>
